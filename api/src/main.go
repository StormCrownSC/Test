...
func main() {
	...
	// // Добавляем обработчик POST-запроса по пути "/api/users/telegram"
	// router.POSR("/api/users/telegram", sendUserTelegram)

	// // Добавляем обработчик GET-запроса по пути "/api/users/telegram"
	// router.GET("/api/users/telegram", getUserTelegram)
